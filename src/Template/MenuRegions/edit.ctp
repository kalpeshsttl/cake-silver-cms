 ...
 */
$this->assign('title',__('Edit Menu Region ( ' . $menuRegion->region .' ) '));
$this->Html->addCrumb(__('Menu'),['action'=>'index']);
$this->Html->addCrumb(__('Edit Menu Region ( ' . $menuRegion->region .' ) '));
?>
<div class="menuRegion edit form">
    <div class="card">
        <div class="page-header border-bottom border-dark mb-2 py-1">
            <h1 class="h5 d-inline"><?= __('Edit Menu Region  ( ' . $menuRegion->region .' ) ') ?></h1>
        ...
        <?php
            ...
            echo $this->Form->control('region',['label' => __('Region')]);
