 ...
 */
$this->assign('title',__('Menu Locations'));
$this->Html->addCrumb(__('Menus'),'javascript:void(0);');
$this->Html->addCrumb(__('Menu Locations'));
?>
<div class="menuRegion index">
    <div class="card">
        <div class="page-header border-bottom border-dark mb-2 py-1">
            <h1 class="h5 d-inline"><?= __('Menu Locations') ?></h1>
            <div class="float-sm-right mt-2 mt-sm-0" role="group" aria-label="menuRegion nav">
                <?=$this->Html->link(
                    __('Create New Menu Location'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-sm btn-outline-dark', 'title' => __('Create New Menu Location')]
                );?>
            </div>
        </div>
            ...
            <table class="table table-hover table-bordered mb-0">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" width="30%"><?= $this->Paginator->sort('region',__('Location')) ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link('<i class="fas fa-bars"></i>', ['controller' => 'Menus', 'action' => 'index', $menuRegion->id],['class' => 'btn btn-sm btn-outline-dark', 'title' => __('Menus'), 'escape' => false]) ?>
                            ...
                            <?= $this->Form->postLink('<i class="far fa-trash-alt"></i>', ['action' => 'delete', $menuRegion->id], ['confirm' => __('Are you sure you want to delete this Menu Location?', $menuRegion->id),'class' => 'btn btn-sm btn-outline-danger', 'title' => __('Delete'), 'escape' => false]) ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
