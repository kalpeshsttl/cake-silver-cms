 ...
 */
$this->assign('title',__('Menu Region ( ' . $menuRegion->region . ' ) '));
$this->Html->addCrumb(__('Menu Regions'),['action'=>'index']);
$this->Html->addCrumb(__('Menu Region ( ' . $menuRegion->region . ' ) '));
?>
<div class="menuRegion view">
    <div class="card">
        <div class="page-header border-bottom border-dark mb-2 py-1">
            <h1 class="h5 d-inline"><?= __('Menu Region ( ' . $menuRegion->region . ' ) ') ?></h1>
            <div class="float-sm-right mt-2 mt-sm-0" role="group" aria-label="menuRegion nav">
                <?=$this->Html->link(
                    '<i class="fa fa-arrow-circle-left"></i>',
                    ['action' => 'index'],
                    ['class' => 'btn btn-sm btn-outline-dark','title' => __('Back to Menu Region'),'escape' => false]
                );?>
                <?= $this->Form->postLink(
                    '<i class="far fa-trash-alt"></i>',
                    ['action' => 'delete', $menuRegion->id],
                    ['confirm' => __('Are you sure you want to delete this Menu Region?', $menuRegion->id),'class' => 'btn btn-sm btn-outline-danger','title' => __('Delete'),'escape' => false]
                )?>
            </div>
        </div>
        <div class="card-body p-0">
            <dl class="row">
                ...
                <dt class="col-sm-3 col-lg-2 mb-1"><?= __('Region') ?></dt>
...
<div class="related-menus view">
    <div class="card">
        <div class="page-header border-bottom border-dark mb-2 py-1">
            <h1 class="h5 d-inline"><?= __('Related Menu') ?></h1>
        </div>
        <div class="card-body p-0">
                ...
                <table class="table table-hover table-bordered mb-0">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <?php /*<th scope="col"><?= __('Menu Region Id') ?></th>*/ ?>
                        ...
                        <?php if (!empty($menuRegion->menus)): ?>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?= $this->Form->postLink('<i class="far fa-trash-alt"></i>', ['controller' => 'Menus', 'action' => 'delete', $menuRegion->id, $menus->id], ['confirm' => __('Are you sure you want to delete this Menu?', $menus->id),'class' => 'btn btn-sm btn-outline-danger', 'title' => __('Delete'), 'escape' => false]) ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
