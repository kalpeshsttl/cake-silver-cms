...
use CakeSilverCms\Controller\MenusController;
use Cake\TestSuite\IntegrationTestCase;

/**
 * CakeSilverCms\Controller\MenusController Test Case
 */
class MenusControllerTest extends IntegrationTestCase
{
    ...
    public $fixtures = [
        ...
        'plugin.cake_silver_cms.modules',
        'plugin.cake_silver_cms.widgets'
    ];
